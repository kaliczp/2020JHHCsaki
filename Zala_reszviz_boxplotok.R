...
boxplot(ETdata, #names=c(" ","2011-2040"," "," ","2041-2070"," "," ","2071-2100"," "),
        ...
        ylim=c(-11,14), col= rep(c("#2b83ba","#abdda4","#fdae61","#d7191c"),3),
        xaxt="n")
...
text(1:12, -11, rep(c("ZL","ZE","ZB","ZA"),3))
dev.off()
...
boxplot(ZalaRdata, #names=c(" ","2011-2040"," "," ","2041-2070"," "," ","2071-2100"," "),
        ...
        ylim=c(-110,50), col= rep(c("#2b83ba","#abdda4","#fdae61","#d7191c"),3),
        xaxt="n")
...
#axis(1, at=6.5,pos=-15 ,"vs. 1981-2010",tick=F)
axis(1,at=c(4.5,8.5),tck=1,lty="dotted",lab=F)
text(1:12, -110, rep(c("ZL","ZE","ZB","ZA"),3))
dev.off()
